  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
	  ...
	  <?php
		 ...
		 $re=mysqli_query($connection,"select stuf.*, titres.libellet, dep.depar,nbconge.*,social.* from stuf,titres,dep,nbconge,social where nbconge.mecano=stuf.mecano and stuf.mecano='".$mecano."' and titres.id=stuf.titre and dep.id=stuf.dep and social.mecano=stuf.mecano");
	  ...
	  ?>
		...
		<div class="form-group row" align=right dir=rtl>
            <label for="recipient-name" class="col-sm-7 col-form-label" dir=rtl>الرقم الآلي :</label>
			    <div class="col-sm-5">
             <input type="text" class="form-control" name="recipientname" id="recipientname" value="<?php echo $r[0] ?>" readonly  align=right dir=rtl>
                </div>
				
				<label for="message-text" class="col-sm-6 col-form-label" dir=rtl>الإسم و اللقب :</label>
			    <div class="col-sm-6">
            <input type="text" class="form-control" id="nomprenom" value="<?php echo $r[1] ?>" readonly  align=right dir=rtl>
                </div>
		</div>
            ...
            <label for="message-text" class="col-sm-7 col-form-label" dir=rtl>رقم بطاقة التعريف :</label>
			    <div class="col-sm-5">
            <input type="text" class="form-control"  name ="cin" value="<?php echo $r[6] ?>"  align=right dir=rtl>
          </div>
            <label for="message-text" class="col-sm-7 col-form-label" dir=rtl align=right >تاريخ الولادة :</label>
			<div class="col-sm-5">
			<input type="date" class="form-control" name="Dnaissance" value="<?php echo $r[4] ?>"  align=right dir=rtl>
           </div>
          
            <label for="message-text" class="col-sm-7 col-form-label" dir="rtl" align="right">تاريخ الانتداب :</label>
			<div class="col-sm-5">
			 <input type="date" class="form-control"  name ="Drecrutement" value="<?php echo $r[5] ?>"  align=right dir=rtl>
          </div>
			...
			<select name="grade" class="form-control">
             <?php $reqsn="select * from titres group by libellet";$ssn=mysqli_query($connection,$reqsn);while($rsn=mysqli_fetch_row($ssn)) {echo "<option value=".$rsn[0];if(@$r[2]==$rsn[0]) echo ' selected="selected" ';echo ">".$rsn[1]."</option>";} ?>
            </select>
			</div>
			...
			<select name="service" id="select6" class="form-control">
				...
				$ssn2=mysqli_query($connection,$reqsn2);while($rsn2=mysqli_fetch_row($ssn2)) {
				...
				$ssn3=mysqli_query($connection,$reqsn3);while($rsn3=mysqli_fetch_row($ssn3)) {
			...
			<select name="dep" id="select7" class="form-control">
                <?php $reqsn="select * from dep";$ssn=mysqli_query($connection,$reqsn);while($rsn=mysqli_fetch_row($ssn)) {echo "<option value=".$rsn[0];if(@$r[3]==$rsn[0]) echo ' selected="selected" ';echo ">".$rsn[2]."</option>";} ?>
            </select>
          </div>
			...
			<div class="col-sm-5">
            <input type="text" class="form-control"  name ="echelle" value="<?php echo $r[9] ?>"  align=right dir=rtl>
          </div>
			...
			<div class="col-sm-5">
			<input type="text" class="form-control" name="echelon" value="<?php echo $r[10] ?>"  align=right dir=rtl>
           </div>
			...
			<div class="col-sm-5">
			<input type="text" class="form-control" name="restconge" value="<?php echo $r[24] ?>"  align=right dir=rtl>
          </div> 

            <label for="message-text" class="col-sm-7 col-form-label" dir="rtl" align="right">رصيد إجازات السّنة الحاليّة :</label>
			<div class="col-sm-5">
			<input type="text" class="form-control" name="soldeconge" value="<?php echo $r[25] ?>"  align=right dir=rtl>
          </div>
			...
			<select name="pointage" id="pointage" dir="rtl" class="form-control">
              <option value="0" <?php if(@$r[19]==0) echo ' selected="selected" ';  ?>>غير معنيّ</option>
              <option value="1" <?php if(@$r[19]==1) echo ' selected="selected" ';  ?>>معنيّ</option>
            </select>
         </div>
		 
            <label for="message-text" class="col-sm-7 col-form-label" dir=rtl align=right >رقم الضمان الإجتماعي :</label>
			<div class="col-sm-5">
			<input type="text" class="form-control" name="codesocial" value="<?php echo $r[28] ?>"  align=right dir=rtl>
           </div>
          
            <label for="message-text" class="col-sm-7 col-form-label" dir="rtl" align="right">رقم التأمين الجماعي :</label>
			<div class="col-sm-5">
		<input type="text" class="form-control" name="codeassurance" value="<?php echo $r[29] ?>"  align=right dir=rtl>
			</div>
			...
			<select name="lait" dir="rtl" class="form-control">
              <option value="1" <?php if(@$r[20]==1) echo ' selected="selected" ';  ?>>نعم</option>
              <option value="0" <?php if(@$r[20]==0) echo ' selected="selected" ';  ?>>لا</option>
            </select>
           </div>
          </div>
