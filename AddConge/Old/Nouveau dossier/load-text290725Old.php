...
<button type=submit class="btn btn-primary" id="SaveData" >حفظ المعطيات</button>
</div>
...
echo '<td><a href="delete.php?id='.$r[0].'&Nbjours='.$r[3].'&mecano='.$mecano.'" onclick="return confirm(\'؟هل تريد حذف الإجازة حقّا\');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
  <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z"/>
  <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
</svg></a></td>
<td><a href="#" data-bs-toggle="modal" data-bs-target="#externalModal" data-url="update_conge.php?id='.$mecano.'&DateDebut='.$CtrlDateDebut->format('Y-m-d').'&DateFin='.$FinishDateConge->format('Y-m-d').'&NbJour='.$r[3].'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
 ...
 <div class="modal fade" id="externalModal" tabindex="-1" aria-labelledby="externalModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered" style="max-width: 800px;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="externalModalLabel">تحيين الإجازة</h5>
  ...
  <script>
    ...
    document.getElementById('externalModal').addEventListener('show.bs.modal', function (event) {
      ...
      var url = button.getAttribute('test.php');
